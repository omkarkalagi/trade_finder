    ...
    <div className="relative" ref={searchRef}>
      <div className="relative">
        <input
          ...
          className="w-full bg-gray-100 rounded-full px-4 py-2 pl-10 text-sm outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all"
        />
        <svg
      ...
      {isOpen && results.length === 0 && query.trim() && !loading && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-200 z-50">
          <div className="p-6 text-center">
            ...
            <p className="text-sm text-gray-400 mt-1">Try searching for stocks, sectors, or features</p>
          </div>
        </div>
      )}
    </div>
