    ...
    <div className="relative" ref={searchRef}>
      <div className="relative">
        <input
          ...
          className="w-full dark-input rounded-full px-4 py-2 pl-10 text-sm outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all placeholder-slate-500"
        />
        <svg
